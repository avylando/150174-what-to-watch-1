...
import FilmsList from "../films_list/films_list.jsx";
import GenresList from "../genres_list/genres_list.jsx";
...
class MainScreen extends React.PureComponent {
  constructor(props) {
    ...
    for (let film of this.props.filmsData) {
      const {genre} = film;
  ...
  render() {
    const {filmsData, activeGenre, filterGenresHandler} = this.props;
    return (
      <div>
        ...
        <div className="page-content">
          <section className="catalog">
            ...
            <GenresList
              ...
              filterGenresHandler={(genre) => filterGenresHandler(genre)}
              genres={this.genres}
            >
            </GenresList>
...
const mapDispatchToProps = (dispatch) => ({
  filterGenresHandler: (genre) => {
    dispatch(ActionCreators[`FILTER_BY_GENRE`](genre));
    dispatch(ActionCreators[`GET_GENRE_FILMS`](genre));
  }
});
